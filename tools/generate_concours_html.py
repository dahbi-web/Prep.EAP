...
def make_page(pdf_path, index):
    ...
    html = '''<!doctype html><html lang="fr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>__TITLE__ · CNC ANASS</title><style>__STYLE__</style></head><body>
<header><div class="head"><div><div class="title">__TITLE__</div><div class="sub">Version HTML interactive · __PAGE_COUNT__ pages</div></div><button onclick="location.href='../#/concours'">← Retour aux concours</button></div></header>
